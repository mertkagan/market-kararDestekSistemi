...
$aSubesiAylikSatis = mysqli_query($baglan,"SELECT * FROM vw_asubesi_aylik_toplamsatistutari");
$aKategorikSatis = mysqli_query($baglan,"SELECT * FROM vw_asubesi_kategoribazli_toplamsatistutari");
$aEncokSatanBesUrun = mysqli_query($baglan,"SELECT * FROM vw_asubesi_encok_toplamtutar5urun");
$aEnCokKazandiranTopUcPersonel = mysqli_query($baglan,"SELECT * FROM vw_asubesi_ilkuc_encokkazandiranpersonel");
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($aKategorikSatis as $row) {
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($aSubesiAylikSatis as $row) {
      ...
      function drawStuff() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($aEncokSatanBesUrun as $row) {
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($aEnCokKazandiranTopUcPersonel as $row) {
