...
$bSubesiAylikSatis = mysqli_query($baglan,"SELECT * FROM vw_bsubesi_aylik_toplamsatistutari");
$bKategorikSatis = mysqli_query($baglan,"SELECT * FROM vw_bsubesi_kategoribazli_toplamsatistutari");
$bEncokSatanBesUrun = mysqli_query($baglan,"SELECT * FROM vw_bsubesi_encok_toplamtutar5urun");
$bEnCokKazandiranTopUcPersonel = mysqli_query($baglan,"SELECT * FROM vw_bsubesi_ilkuc_encokkazandiranpersonel");
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($bKategorikSatis as $row) {
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($bSubesiAylikSatis as $row) {
      ...
      function drawStuff() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($bEncokSatanBesUrun as $row) {
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            foreach($bEnCokKazandiranTopUcPersonel as $row) {
